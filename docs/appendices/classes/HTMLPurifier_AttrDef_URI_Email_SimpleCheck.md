...
* Full name: `\HTMLPurifier_AttrDef_URI_Email_SimpleCheck`
* Parent class: [`\HTMLPurifier_AttrDef_URI_Email`](./HTMLPurifier_AttrDef_URI_Email.md)
...
```php
public unpack(string $string): mixed
```
