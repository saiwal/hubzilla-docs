...
* Full name: `\OAuth2\Storage\DynamoDB`
...
```php
public getPublicKey(mixed $client_id = &#039;0&#039;): mixed
```
...
```php
public getPrivateKey(mixed $client_id = &#039;0&#039;): mixed
```
...
```php
private dynamo2array(mixed $dynamodbResult): mixed
```
...
```php
private static isNotEmpty(mixed $value): mixed
```
