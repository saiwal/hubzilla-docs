...
* Full name: `\Smarty_Internal_Compile_Capture`
...
```php
public static compileSpecialVariable(array $args, \Smarty_Internal_TemplateCompilerBase $compiler, array $parameter = null): string
```
...
```php
public compile(array $args, \Smarty_Internal_TemplateCompilerBase $compiler, null $parameter = null): string
```
