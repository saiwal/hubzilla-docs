...
* Full name: `\Zotlabs\ActivityStreams\CollectionPage`
...
```php
public setPartOf(mixed $partOf): \Zotlabs\ActivityStreams\CollectionPage
```
...
```php
public setNext(mixed $next): \Zotlabs\ActivityStreams\CollectionPage
```
...
```php
public setPrev(mixed $prev): \Zotlabs\ActivityStreams\CollectionPage
```
