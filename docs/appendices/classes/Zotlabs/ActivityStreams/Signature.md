...
* Full name: `\Zotlabs\ActivityStreams\Signature`
...
```php
public setCreator(mixed $creator): \Zotlabs\ActivityStreams\Signature
```
...
```php
public getSignatureValue(): mixed
```
...
```php
public setSignatureValue(mixed $signatureValue): \Zotlabs\ActivityStreams\Signature
```
...
```php
public setNonce(mixed $nonce): \Zotlabs\ActivityStreams\Signature
```
