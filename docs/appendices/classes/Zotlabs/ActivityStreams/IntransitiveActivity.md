...
* Full name: `\Zotlabs\ActivityStreams\IntransitiveActivity`
...
```php
public setActor(mixed $actor): \Zotlabs\ActivityStreams\IntransitiveActivity
```
...
```php
public setResult(mixed $result): \Zotlabs\ActivityStreams\IntransitiveActivity
```
...
```php
public setOrigin(mixed $origin): \Zotlabs\ActivityStreams\IntransitiveActivity
```
...
```php
public setInstrument(mixed $instrument): \Zotlabs\ActivityStreams\IntransitiveActivity
```
