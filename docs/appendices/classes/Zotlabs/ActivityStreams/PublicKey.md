...
* Full name: `\Zotlabs\ActivityStreams\PublicKey`
...
```php
public setOwner(mixed $owner): \Zotlabs\ActivityStreams\PublicKey
```
...
```php
public setSignatureAlgorithm(mixed $signatureAlgorithm): \Zotlabs\ActivityStreams\PublicKey
```
...
```php
public setPublicKeyPem(mixed $publicKeyPem): \Zotlabs\ActivityStreams\PublicKey
```
