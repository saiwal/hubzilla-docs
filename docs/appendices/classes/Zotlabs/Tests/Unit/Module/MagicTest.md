...
* Full name: `\Zotlabs\Tests\Unit\Module\MagicTest`
...
### test_init_with_no_args



```php
public test_init_with_no_args(): void
```
...
### test_local_request_without_delegate



```php
public test_local_request_without_delegate(): void
```
...
### test_delegate_request_switches_channel_when_allowed



```php
public test_delegate_request_switches_channel_when_allowed(): void
```
