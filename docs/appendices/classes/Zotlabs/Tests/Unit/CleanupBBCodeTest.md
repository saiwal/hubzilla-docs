...
* Full name: `\Zotlabs\Tests\Unit\CleanupBBCodeTest`
...
```php
public test_cleanup_bbcode(string $expected, string $input): void
```
...
### cleanup_bbcode_provider



```php
public static cleanup_bbcode_provider(): array
```
