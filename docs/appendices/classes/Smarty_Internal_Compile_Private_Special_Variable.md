...
* Full name: `\Smarty_Internal_Compile_Private_Special_Variable`
...
```php
public compile(array $args, \Smarty_Internal_TemplateCompilerBase $compiler, mixed $parameter): string
```
