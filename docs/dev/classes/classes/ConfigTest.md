...
### testGetPlainTextValue



```php
public testGetPlainTextValue(): void
```
...
### testGetJSONSerializedArray



```php
public testGetJSONSerializedArray(): void
```
...
### testGetPHPSerializedArray



```php
public testGetPHPSerializedArray(): void
```
...
### testGetPHPUnserializedArray



```php
public testGetPHPUnserializedArray(): void
```
...
### testGetMaliciousPHPSerializedArray



```php
public testGetMaliciousPHPSerializedArray(): void
```
