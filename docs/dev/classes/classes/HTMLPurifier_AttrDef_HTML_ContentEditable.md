...
* Full name: `\HTMLPurifier_AttrDef_HTML_ContentEditable`
...
```php
public validate(mixed $string, mixed $config, mixed $context): mixed
```
...
|-----------|------|-------------|
| `$string` | **mixed** | String to be validated and cleaned. |
| `$config` | **mixed** | Mandatory HTMLPurifier_Config object. |
| `$context` | **mixed** | Mandatory HTMLPurifier_Context object. |
