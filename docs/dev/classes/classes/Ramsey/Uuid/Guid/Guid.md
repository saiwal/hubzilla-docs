...
* Full name: `\Ramsey\Uuid\Guid\Guid`
...
* https://en.wikipedia.org/wiki/Universally_unique_identifier#Variants - UUID Variants on Wikipedia
* https://docs.microsoft.com/en-us/windows/win32/api/guiddef/ns-guiddef-guid - Windows GUID structure
* https://docs.microsoft.com/en-us/dotnet/api/system.guid - .NET Guid Struct
* https://docs.microsoft.com/en-us/dotnet/api/system.guid.tobytearray - .NET Guid.ToByteArray Method
...
```php
public __construct(\Ramsey\Uuid\Guid\Fields $fields, \Ramsey\Uuid\Converter\NumberConverterInterface $numberConverter, \Ramsey\Uuid\Codec\CodecInterface $codec, \Ramsey\Uuid\Converter\TimeConverterInterface $timeConverter): mixed
```
...
|-----------|------|-------------|
| `$fields` | **\Ramsey\Uuid\Guid\Fields** | The fields from which to construct a UUID |
