...
```php
public activate(mixed $pdo, mixed $channel): mixed
```
...
```php
public get_cdav_data(mixed $id, mixed $table): mixed
```
...
```php
public request_to_array(mixed $req): mixed
```
