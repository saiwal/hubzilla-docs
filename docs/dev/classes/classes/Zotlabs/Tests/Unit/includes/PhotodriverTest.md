...
* Full name: `\Zotlabs\Tests\Unit\includes\PhotodriverTest`
...
### testPhotofactoryReturnsNullForUnsupportedType



```php
public testPhotofactoryReturnsNullForUnsupportedType(): mixed
```
...
### testPhotofactoryReturnsPhotogdIfConfigIgnore_imagickIsSet



```php
public testPhotofactoryReturnsPhotogdIfConfigIgnore_imagickIsSet(): mixed
```
