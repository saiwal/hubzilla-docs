...
* Full name: `\Zotlabs\Tests\Unit\includes\LanguageTest`
...
```php
public testGetLanguageName(mixed $lang, mixed $name, mixed $trans): mixed
```
...
### getLanguageNameProvider



```php
public static getLanguageNameProvider(): mixed
```
