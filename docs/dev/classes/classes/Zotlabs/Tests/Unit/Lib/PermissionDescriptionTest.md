...
# PermissionDescriptionTest

Base class for our Unit Tests.



* Full name: `\Zotlabs\Tests\Unit\Lib\PermissionDescriptionTest`
...
```php
public testFromDescription(): mixed
```
...
### testFromStandalonePermission



```php
public testFromStandalonePermission(): mixed
```
...
### testFromGlobalPermission

Test fetching permission descriptions for the current channel.

```php
public testFromGlobalPermission(): mixed
```
...
### testGetPermissionDescription



```php
public testGetPermissionDescription(): mixed
```
