...
* Full name: `\Zotlabs\Tests\Unit\Lib\ActivityTest`
...
```php
public test_get_textfield(array $src, null|string|array $expected): void
```
...
### get_textfield_provider

Dataprovider for test_get_textfield.

```php
public static get_textfield_provider(): array
```
