...
* Full name: `\Zotlabs\ActivityStreams\Relationship`
...
```php
public setSubject(mixed $subject): \Zotlabs\ActivityStreams\Relationship
```
...
```php
public setObject(mixed $object): \Zotlabs\ActivityStreams\Relationship
```
...
```php
public setRelationship(mixed $relationship): \Zotlabs\ActivityStreams\Relationship
```
