...
* Full name: `\Zotlabs\ActivityStreams\Place`
...
```php
public setAccuracy(mixed $accuracy): \Zotlabs\ActivityStreams\Place
```
...
```php
public setAltitude(mixed $altitude): \Zotlabs\ActivityStreams\Place
```
...
```php
public setLatitude(mixed $latitude): \Zotlabs\ActivityStreams\Place
```
...
```php
public setLongitude(mixed $longitude): \Zotlabs\ActivityStreams\Place
```
...
```php
public setRadius(mixed $radius): \Zotlabs\ActivityStreams\Place
```
...
```php
public setUnits(mixed $units): \Zotlabs\ActivityStreams\Place
```
