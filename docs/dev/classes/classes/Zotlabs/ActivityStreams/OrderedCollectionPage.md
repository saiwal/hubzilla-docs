...
* Full name: `\Zotlabs\ActivityStreams\OrderedCollectionPage`
* Parent class: [`\Zotlabs\ActivityStreams\OrderedCollection`](./OrderedCollection.md)
...
```php
public setPartOf(mixed $partOf): \Zotlabs\ActivityStreams\OrderedCollectionPage
```
...
```php
public setNext(mixed $next): \Zotlabs\ActivityStreams\OrderedCollectionPage
```
...
```php
public setPrev(mixed $prev): \Zotlabs\ActivityStreams\OrderedCollectionPage
```
...
```php
public setStartIndex(mixed $startIndex): \Zotlabs\ActivityStreams\OrderedCollectionPage
```
