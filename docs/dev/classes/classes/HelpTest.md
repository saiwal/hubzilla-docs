...
### test_get_request_when_help_file_exists

Test getting a help page when the underlying file exists.

```php
public test_get_request_when_help_file_exists(string $ext): void
```
...
### test_get_request_should_return_404_when_help_file_does_not_exist



```php
public test_get_request_should_return_404_when_help_file_does_not_exist(): void
```
...
### test_get_request_without_args_redirects_to_about_page



```php
public test_get_request_without_args_redirects_to_about_page(): void
```
...
### test_getting_locale_with_no_topic_should_redirect_to_about_page



```php
public test_getting_locale_with_no_topic_should_redirect_to_about_page(): void
```
...
### test_find_help_file_returns_first_match



```php
public test_find_help_file_returns_first_match(): void
```
...
### test_fall_back_to_english_if_localized_topic_dont_exist



```php
public test_fall_back_to_english_if_localized_topic_dont_exist(): void
```
...
### test_include_file_of_different_type_than_main_file



```php
public test_include_file_of_different_type_than_main_file(): void
```
...
```php
private prepare_stubs(string $ext): array
```
