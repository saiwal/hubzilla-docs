...
### test_relative_time_past



```php
public test_relative_time_past(): mixed
```
...
### test_relative_time_future



```php
public test_relative_time_future(): mixed
```
...
### test_relative_time_now



```php
public test_relative_time_now(): mixed
```
...
### test_relative_time_future_minutes



```php
public test_relative_time_future_minutes(): mixed
```
...
### test_relative_time_past_seconds



```php
public test_relative_time_past_seconds(): mixed
```
