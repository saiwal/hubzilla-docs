...
* Full name: `\HTMLPurifier_AttrDef_CSS_ImportantDecorator`
...
```php
public __construct(\HTMLPurifier_AttrDef $def, bool $allow = false): mixed
```
...
| `$allow` | **bool** | Whether or not to allow !important |
