...
* Full name: `\HTMLPurifier_AttrDef_HTML_ID`
...
```php
public __construct(bool $selector = false): mixed
```
...
```php
public validate(string $id, \HTMLPurifier_Config $config, \HTMLPurifier_Context $context): bool|string
```
