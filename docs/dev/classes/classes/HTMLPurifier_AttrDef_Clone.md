...
* Full name: `\HTMLPurifier_AttrDef_Clone`
...
```php
public __construct(\HTMLPurifier_AttrDef $clone): mixed
```
...
```php
public validate(string $v, \HTMLPurifier_Config $config, \HTMLPurifier_Context $context): bool|string
```
