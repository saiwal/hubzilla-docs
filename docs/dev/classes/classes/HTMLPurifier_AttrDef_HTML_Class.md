...
* Full name: `\HTMLPurifier_AttrDef_HTML_Class`
* Parent class: [`\HTMLPurifier_AttrDef_HTML_Nmtokens`](./HTMLPurifier_AttrDef_HTML_Nmtokens.md)
...
```php
protected split(string $string, \HTMLPurifier_Config $config, \HTMLPurifier_Context $context): bool|string
```
...
```php
protected filter(array $tokens, \HTMLPurifier_Config $config, \HTMLPurifier_Context $context): array
```
