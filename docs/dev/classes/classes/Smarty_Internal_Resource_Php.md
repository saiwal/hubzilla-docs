...
* Full name: `\Smarty_Internal_Resource_Php`
* Parent class: [`\Smarty_Internal_Resource_File`](./Smarty_Internal_Resource_File.md)
...
**Throws:**
<p>if template cannot be loaded or allow_php_templates is disabled</p>
